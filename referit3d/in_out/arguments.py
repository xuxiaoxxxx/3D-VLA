...
def parse_arguments(notebook_options=None):
    ...
    #
    parser.add_argument('-scannet-file', type=str, default='/data/xuxiaoxu/dataset/scannet/scan_vg_nr3/keep_all_points_00_view_with_global_scan_alignment/keep_all_points_00_view_with_global_scan_alignment.pkl',
                         help='pkl file containing the data of Scannet'
                        ' as generated by running XXX')
    parser.add_argument('-referit3D-file', type=str, default='/data/xuxiaoxu/dataset/scannet/scan_vg_nr3/nr3d.csv')

    #### sr3d ####
    # parser.add_argument('-scannet-file', type=str, default='/data/xuxiaoxu/code/3dvg/referit3d_2d_data/referit3d/data/scannet/sr3d/keep_all_points_with_global_scan_alignment/keep_all_points_with_global_scan_alignment.pkl',
    #                      help='pkl file containing the data of Scannet'
    #                     ' as generated by running XXX')
    # parser.add_argument('-referit3D-file', type=str, default='/data/xuxiaoxu/dataset/scannet/scan_vg_sr3/sr3/sr3d.csv')
    ...
    parser.add_argument('--bert-pretrain-path', type=str, default="/data/xuxiaoxu/code/3dvg/MVT-ws-3DVG/referit3d/bert-base-uncased")
    
    parser.add_argument('--view_number', type=int, default=1)
    ...
    parser.add_argument('--object-latent-dim', type=int, default=512)
    parser.add_argument('--inner-dim', type=int, default=512)

    parser.add_argument('--dropout-rate', type=float, default=0.15)
    parser.add_argument('--lang-cls-alpha', type=float, default=0, help='if > 0 a loss for guessing the target via '
                                                                          'language only is added.')
    parser.add_argument('--obj-cls-alpha', type=float, default=0, help='if > 0 a loss for guessing for each segmented'
                                                                         ' object its class type is added.')
    parser.add_argument('--contrastive-alpha', type=str2bool, default=True)                                                                     

    #
    # Misc arguments
    #
    parser.add_argument('--gpu', type=str, default='6', help='specify gpu device. [default: 0]')
    parser.add_argument('--n-gpus', type=int, default=1, help='number gpu devices. [default: 1]')
    parser.add_argument('--batch-size', type=int, default=48, help='batch size per gpu. [default: 32]')
