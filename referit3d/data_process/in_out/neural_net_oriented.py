...
from .nr3d import decode_stimulus_string
...
def scannet_official_train_val(valid_views=None, verbose=True):
    ...
    train_split = osp.join('/data/xuxiaoxu/code/3dvg/3D-VLA/referit3d/data/scannet/splits/official/v2/scannetv2_train.txt')
    train_split = read_lines(train_split)
    test_split = osp.join('/data/xuxiaoxu/code/3dvg/3D-VLA/referit3d/data/scannet/splits/official/v2/scannetv2_val.txt')
