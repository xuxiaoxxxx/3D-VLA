...
def parse_arguments(notebook_options=None):
    ...
    #
    parser.add_argument('-scannet-file', type=str, default='/data/xuxiaoxu/code/3dvg/referit3d_2d_data/referit3d/data/scannet/keep_all_points_00_view_with_global_scan_alignment/keep_all_points_00_view_with_global_scan_alignment.pkl',
    ...
    #
    parser.add_argument('--log-dir', type=str, default='log', help='where to save training-progress, model, etc')
    ...
    parser.add_argument('--batch-size', type=int, default=1, help='batch size per gpu. [default: 32]')
