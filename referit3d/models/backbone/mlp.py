...
class MLP(nn.Module):
    ...
    """
    def __init__(self, in_feat_dims, out_channels, dropout_rate=0,
                 non_linearity=nn.ReLU(inplace=True), closure=None, norm_type=nn.BatchNorm1d):
        """Constructor
        ...
        for depth in range(len(out_channels)):
            ...
            # print("previous_feat_dim shape:", previous_feat_dim, out_dim)
